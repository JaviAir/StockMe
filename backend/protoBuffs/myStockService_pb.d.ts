...
export class StockName extends jspb.Message { 
    getName(): string;
    setName(value: string): StockName;
...
export class theStock extends jspb.Message { 
    getName(): string;
    setName(value: string): theStock;

    getSymbol(): string;
    setSymbol(value: string): theStock;

    getPrice(): number;
    setPrice(value: number): theStock;
...
export class theStockPrice extends jspb.Message { 
    getPrice(): number;
    setPrice(value: number): theStockPrice;
